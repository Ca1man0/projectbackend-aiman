...
import com.fasterxml.jackson.annotation.JsonIgnore; // Importa questo
...
public class Address {
    ...
    // OneToOne --> stabilisco la relazione, dicendo che un indirizzo appartiene ad un solo utente
    @OneToOne
    ...
    // Questo costruttore mi serve per creare i miei oggetti address
