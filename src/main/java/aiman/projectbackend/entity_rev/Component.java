...
public class Component extends Product {
    ...
    /**
     * Definisco i campi che andranno comporre il mio component:
     * - materiale
     * - diametro
     */
    ...
    // Questo costruttore mi serve per creare i miei oggetti component
    public Component(String name, String description, Double price, Integer stockQuantity, Category category, String material, Double diameter) {
        // Qui chiamo il costruttore padre in cui riporto i dati base del prodotto e poi aggiungo i campi di specializzaione
        super(name, description, price, stockQuantity, category);
