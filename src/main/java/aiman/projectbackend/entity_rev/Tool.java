...
public class Tool extends Product {
    ...
    /**
     * Definisco i campi che andranno comporre il mio tool:
     * - nome del brand
     * - se è elettrico
     */
    ...
    // Questo costruttore mi serve per creare i miei oggetti tool
    public Tool(String name, String description, Double price, Integer stockQuantity, Category category, String brand, Boolean isElectric) {
